<template>
    <button
        v-if="isLoading"
        :disabled="true"
        class="cursor-not-allowed bg-gray-500 flex max-w-xs flex-1 items-center justify-center rounded-md border border-transparent  px-8 py-3 text-base font-medium text-white sm:w-full"
    >
    ...
    <button
        ...
        class="flex max-w-xs flex-1 items-center justify-center rounded-md border border-transparent  px-8 py-3 text-base font-medium text-white sm:w-full"
    >
        {{ title }}
    </button>
</template>
